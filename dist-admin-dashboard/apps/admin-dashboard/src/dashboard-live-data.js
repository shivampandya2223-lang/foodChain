...
exports.dashboardSeedEvents = exports.dashboardTransactions = exports.dashboardBusinessSnapshot = void 0;
exports.createDashboardEventAnalytics = createDashboardEventAnalytics;
exports.getNextLiveDashboardEvent = getNextLiveDashboardEvent;
exports.getNextAnalyticsBatch = getNextAnalyticsBatch;
...
exports.dashboardBusinessSnapshot = {
...
function createDashboardEventAnalytics() {
    const byTopic = {
        [kafka_topic_enum_1.KafkaTopic.ORDER_CREATED]: 78_420,
        [kafka_topic_enum_1.KafkaTopic.ORDER_UPDATED]: 62_880,
        [kafka_topic_enum_1.KafkaTopic.ORDER_CANCELLED]: 5_740,
        [kafka_topic_enum_1.KafkaTopic.INVENTORY_STOCK_IN]: 21_360,
        [kafka_topic_enum_1.KafkaTopic.INVENTORY_STOCK_OUT]: 44_920,
        [kafka_topic_enum_1.KafkaTopic.TASK_CREATED]: 13_640,
        [kafka_topic_enum_1.KafkaTopic.TASK_COMPLETED]: 11_280,
        [kafka_topic_enum_1.KafkaTopic.SHOP_CREATED]: 280,
        [kafka_topic_enum_1.KafkaTopic.USER_CREATED]: 10_080,
    };
...
exports.dashboardSeedEvents = [
    {
        topic: kafka_topic_enum_1.KafkaTopic.ORDER_CREATED,
    ...
    {
        topic: kafka_topic_enum_1.KafkaTopic.ORDER_UPDATED,
    ...
    {
        topic: kafka_topic_enum_1.KafkaTopic.INVENTORY_STOCK_OUT,
    ...
    {
        topic: kafka_topic_enum_1.KafkaTopic.TASK_CREATED,
    ...
    {
        topic: kafka_topic_enum_1.KafkaTopic.INVENTORY_STOCK_IN,
    ...
    {
        topic: kafka_topic_enum_1.KafkaTopic.SHOP_CREATED,
    ...
    {
        topic: kafka_topic_enum_1.KafkaTopic.USER_CREATED,
...
const liveEventTemplates = [
    ...
    {
        topic: kafka_topic_enum_1.KafkaTopic.TASK_COMPLETED,
...
function getNextLiveDashboardEvent() {
    const template = liveEventTemplates[liveEventCursor % liveEventTemplates.length];
    liveEventCursor += 1;
    return {
        ...template,
...
function getNextAnalyticsBatch() {
    const topics = Object.values(kafka_topic_enum_1.KafkaTopic);
    const services = [
        'Core API',
        'Inventory Service',
